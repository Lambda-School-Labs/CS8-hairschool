...
class SignIn extends React.Component {
	...
	constructor(props) {
		...
		this.URL = "https://john-cs8-hairschool.herokuapp.com"; // change this to the heroku link later on
		this.state = {
			showError: false
		}
	}
	...
	buttonHandler(login, history) {
		...
		if (username === "") this.setState({ showError: true});
		axios
			...
			<div className="SignIn">
				...
				<Form className="SignInForm">
					...
					<FormGroup>
						...
						{this.state.showError ? this.showError() : false}
